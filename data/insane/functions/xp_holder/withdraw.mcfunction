...
execute as @e[tag=xp_holder,type=minecraft:armor_stand,scores={xpHeld=10..}] at @s positioned ~-.4 ~-2.05 ~0.3 if entity @p[distance=..0.5] run tag @s add withdrawing_xp
