...
execute if entity @s[tag=es.has_enchantment_0] run summon item ~ ~ ~ {Item:{id:"minecraft:enchanted_book",Count:1b,tag:{}},Tags:["es.enchanted_book_0"]}
...
execute if entity @s[tag=es.has_enchantment_1] run summon item ~ ~ ~ {Item:{id:"minecraft:enchanted_book",Count:1b,tag:{}},Tags:["es.enchanted_book_1"]}
...
execute if entity @s[tag=es.has_enchantment_2] run summon item ~ ~ ~ {Item:{id:"minecraft:enchanted_book",Count:1b,tag:{}},Tags:["es.enchanted_book_2"]}
...
execute if entity @s[tag=es.has_enchantment_3] run summon item ~ ~ ~ {Item:{id:"minecraft:enchanted_book",Count:1b,tag:{}},Tags:["es.enchanted_book_3"]}
