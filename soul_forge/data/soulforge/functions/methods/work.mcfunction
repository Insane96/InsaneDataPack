...
#particles
execute as @e[tag=soul_forge] at @s if block ~ ~ ~ minecraft:blast_furnace[lit=true]{Items:[{Slot:0b,id:"minecraft:gold_ore"}]} positioned ^ ^ ^1 run particle minecraft:campfire_cosy_smoke ~ ~.75 ~ 0 0 0 0.05 1
execute as @e[tag=soul_forge] at @s if block ~ ~ ~ minecraft:blast_furnace[lit=true]{Items:[{Slot:0b,id:"minecraft:iron_ore"}]} positioned ^ ^ ^1 run particle minecraft:campfire_cosy_smoke ~ ~.75 ~ 0 0 0 0.05 1
