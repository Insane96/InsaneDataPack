execute as @e[type=item,nbt={Item:{id:"minecraft:diamond",Count:1b}}] at @s if block ~ ~ ~ minecraft:soul_fire align xyz run summon armor_stand ~.5 ~.5 ~.5 {NoGravity:1b,Invisible:1b,Marker:1b,Tags:["soul_forge_craft"]}
