...
execute as @e[tag=vh.successful_crafting] at @s align xyz positioned ~.5 ~.5 ~.5 run summon armor_stand ~.4 ~-.4 ~-.3 {Invisible:1b,NoGravity:1b,Marker:1b,ArmorItems:[{},{},{},{}],HandItems:[{id:"minecraft:ender_pearl",Count:1b},{}],DisabledSlots:2039583,Tags:["vh.hopper","vh.tier_1"],Pose:{RightArm:[0f,0f,0f]},CustomName:'{"text": "Basic Vacuum Hopper"}'}
