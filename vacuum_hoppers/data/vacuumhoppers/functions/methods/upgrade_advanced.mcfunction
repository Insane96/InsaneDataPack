...
execute as @e[tag=vh.successful_upgrade_advanced] run data modify entity @s {} merge value {HandItems:[{id:"minecraft:ender_eye",Count:1b},{}],DisabledSlots:2039583,Tags:["vh.hopper","vh.tier_2","vh.successful_upgrade_advanced"],CustomName:'{"text": "Advanced Vacuum Hopper"}'}
