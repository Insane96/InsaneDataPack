...
execute as @e[tag=vh.successful_upgrade_super] run data modify entity @s {} merge value {HandItems:[{id:"minecraft:chorus_fruit",Count:1b},{}],DisabledSlots:2039583,Tags:["vh.hopper","vh.tier_3","vh.successful_upgrade_super"],CustomName:'{"text": "Super Vacuum Hopper"}'}
